...
public class ChatActivity extends BaseActivity implements FuncLayout.OnFuncKeyBoardListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.M) {
            ActivityCompat.requestPermissions(this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA, Manifest.permission.RECORD_AUDIO},1);
        }
        ...
        if (!TextUtils.isEmpty(mTargetId)) {
            ...
            JMessageClient.getUserInfo(mTargetId, new GetUserInfoCallback() {
                ...
                public void gotResult(int i, String s, UserInfo userInfo) {
                    ...
                    Log.e("retrofit", "gotResult() called with: i = [" + i + "], s = [" + s + "], userInfo.getNickname() = [" + userInfo.getNickname() + "]");
                }
            });
        } else {
            //群聊
    ...
    private void initEmoticonsKeyBoardBar() {
        ...
        ekBar.getBtnSend().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //文本聊天消息同步到后台
                EventBus.getDefault().post(new ImEvent(mTargetId, mcgContent, ContentType.text.toString()));
            }
        });
        //切换语音输入
...
//        List<MessageReceiptStatusChangeEvent.MessageReceiptMeta> messageReceiptMetas = event.getMessageReceiptMetas();//todo
        ...
        switch (event.getFlag()) {
            ...
            case JGApplication.TAKE_PHOTO_MESSAGE:
                if ((ContextCompat.checkSelfPermission(ChatActivity.this, Manifest.permission.CAMERA)
                    ...
                    ChatActivity.this.startActivityForResult(intent, RequestCode.TAKE_PHOTO);
                }
                break;
