...
public class ConversationListFragment extends BaseFragment {
    ...
    public static int HEAD_VIEW_COUNT = 2;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRootView = layoutInflater.inflate(getFragmentLayoutId(),
                (ViewGroup) getActivity().findViewById(R2.id.main_view), false);
    ...
    public static ConversationListFragment newInstance(boolean isShowTopBar) {
        ConversationListFragment fragment = new ConversationListFragment();
        Bundle args = new Bundle();
        args.putBoolean("isShowTopBar", isShowTopBar);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            isShowTopBar = getArguments().getBoolean("isShowTopBar", false);
        }
        if(isShowTopBar) {
            topView = mRootView.findViewById(R.id.top_view);
            tvTopbarTitle = mRootView.findViewById(R.id.tv_topbar_title);
            PixelSizeUtil.setStatusBarHeightViewWhite(topView);
