...
public class PixelSizeUtil {
    ...
    /**
     * 设置View的高度为状态栏高度,背景为白色或半透明
     */
    public static void setStatusBarHeightViewWhite(View view) {
        int height = getStatusHeight(view.getContext());
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            color = ContextCompat.getColor(view.getContext(), R.color.transparent_black);
        }
