...
public class ConversationListAdapter extends BaseAdapter {
    ...
    public ConversationListView getmConversationListView() {
...
//                                    content.setText("[已读]" + contentStr);//TODO
                                    content.setText(contentStr);
                                } else {
                                    content.setText(contentStr);
                                }
...
//                                    content.setText(builder);
        ...
        if (convItem.getType().equals(ConversationType.single)) {
            ...
            if(mUserInfo !=null) {
                FileUtils.loadAvatar(mContext, mUserInfo.getAvatar(), headIcon, R.drawable.jmui_head_icon);
            }else {
            ...
            if (mGroupInfo != null) {
                FileUtils.loadAvatar(mContext, mGroupInfo.getAvatar(), headIcon, R.drawable.group);
