...
/**
 * @description 我的生活发布及黄页生活公共列表
 * @author hdl
 * @date 2019/5/30
 */
open class MyReleaseLifeCommonAdapter(context: Context, datas: List<LifeGeneralInfo>) :
        LifeReleaseCommonAdapter<LifeGeneralInfo>(context, datas) {
