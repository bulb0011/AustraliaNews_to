 ...
 * @date 2020/3/28
 */
class WealthMyBrowseListFragment : BaseFragment() {
    ...
    class NewsListPageDataSource @Inject constructor(apiService: ApiService) :
        ...
        override fun fetchData(
            ...
            return apiService.getWealthBrowsePageList(params).compose(RxUtil.normalSchedulers())
        }
    }
...
//                tipDialog.show("温馨提示", "是否确认删除选中新闻收藏?", "确认")
     ...
     * 删除浏览
     */
    private fun deleteWealthBrowseInfo() {
        ...
        if (deleteType == 2) {
            ...
            params.historyInfoOids = collectionInfoOids
        }
        showLoadingView(R.string.in_submit)
        val subscription = ApiManger.getApiService().deleteWealthBrowseInfo(params)
            ...
            .subscribe(object : ApiSuccessAction<ResultBase<*>>() {
                override fun onSuccess(result: ResultBase<*>) {
                    ...
                    (activity as WealthMyBrowseListActivity).onTopBarRightTextClick()
                }
