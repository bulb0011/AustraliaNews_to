 ...
 * @date 2020/3/26
 */
class ActivitysListFragment : BaseFragment() {
    ...
    class NewsListPageDataSource @Inject constructor(apiService: ApiService) :
        ...
        override fun fetchData(
            ...
            return apiService.getActivitysPageList(params).compose(RxUtil.normalSchedulers())
        }
    }
    ...
    val adapter by lazy {
        WealthCommonAdapter<ActivitysInfo>(
            mContext,
            arrayListOf()
        )
    }
    ...
    private lateinit var headerAdapter: RvHeaderFootViewAdapter<ActivitysInfo>
