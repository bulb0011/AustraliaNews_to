...
import kotlinx.android.synthetic.main.fragment_home_page_evaluation_list.*
import rx.Observable
import javax.inject.Inject

/**
 * @author hdl
 * @description 我的评价列表(别人查看)
 * @date 2019/6/11
 */
class HomePageEvaluationListFragment : BaseFragment() {

    class NewsListPageDataSource @Inject constructor(apiService: ApiService) : PageDataSource<ResultBase<*>, EvaluationListParams>(apiService) {
    ...
    companion object {
        fun newHomePageEvaluationListFragment(userOid: String?): HomePageEvaluationListFragment {
            val fragment = HomePageEvaluationListFragment()
            val bundle = Bundle()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        mContentView = inflater.inflate(R.layout.fragment_home_page_evaluation_list, container, false)
    ...
    private fun initView() {
        ...
        params.userOid = arguments?.getString(C.IntentKey.USER_OID)
