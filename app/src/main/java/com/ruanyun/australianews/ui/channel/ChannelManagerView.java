...
public class ChannelManagerView extends FrameLayout {
    ...
    public void setDataChangeListenter(@NonNull ChannelAdapter.DataChangeListener listenter) {
    ...
    private void init() {
        ...
        manager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            ...
            public int getSpanSize(int position) {
                ...
                return viewType == ChannelAdapter.TYPE_MY || viewType == ChannelAdapter.TYPE_OTHER || viewType == ChannelAdapter.TYPE_CUSTOMIZE ? 1 : 4;
            }
        });
