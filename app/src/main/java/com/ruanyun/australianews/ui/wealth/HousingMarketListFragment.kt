 ...
 * @date 2020/3/26
 */
class HousingMarketListFragment : BaseFragment() {
    ...
    class NewsListPageDataSource @Inject constructor(apiService: ApiService) :
        ...
        override fun fetchData(
            ...
            return apiService.getHousingMarketPageList(params).compose(RxUtil.normalSchedulers())
        }
    }
    ...
    val adapter by lazy {
        WealthCommonAdapter<HousingMarketInfo>(
            mContext,
            arrayListOf()
        )
    }
    ...
    private lateinit var headerAdapter: RvHeaderFootViewAdapter<HousingMarketInfo>
