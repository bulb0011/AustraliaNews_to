package com.ruanyun.australianews.widget.switchview;
...
public class SwitchView extends View implements View.OnClickListener {
    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        checked = a.getBoolean(R.styleable.SwitchView_setChecked, false);//false message_bubble_left , true right
    ...
    private void initPaint() {
        ...
        clickPaint.setStrokeJoin(Paint.Join.ROUND);

        leftTextPaint = new Paint();
        leftTextPaint.setTextSize(sp2px(10));
        leftTextPaint.setAntiAlias(true);
        rightTextPaint = new Paint();
        rightTextPaint.setTextSize(sp2px(10));
    ...
    private void offsetWidth(float w) {
        ...
        shapeDrawable = new DrawableBuilder()
                .rectangle()
                .cornerRadius((int) (mHeight / 4))
                .strokeColor(Color.parseColor("#0D76FF"))
                .strokeWidth(2)
                .solidColor(Color.parseColor("#F3F8FF"))
                .build();
        shapeDrawable.setBounds((int) (0 + padding + w), (int) (0 + padding), (int) (mClickWidth + padding + w), (int) (mHeight - padding));
    }
    ...
    private void getPath(Path path, float padding, float width, float offset) {
        ...
        path.rewind();
        //绘制
        path.addRoundRect(roundRect, mHeight / 4, mHeight / 4, Path.Direction.CW);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        bgDrawable = new DrawableBuilder()
                .rectangle()
                .cornerRadius((int) (mHeight / 4))
                .strokeColor(Color.parseColor("#999999"))
                .strokeWidth(2)
                .build();

        bgDrawable.setBounds((int) (0), (int) (0), (int) (mWidth), (int) (mHeight));
