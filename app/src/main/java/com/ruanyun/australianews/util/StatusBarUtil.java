...
public final class StatusBarUtil {
    ...
    private StatusBarUtil(Window window,
        ...
        v.post(new Runnable() {
            ...
            public void run() {
                v.setPadding(v.getPaddingLeft(),
                        v.getPaddingTop() + getStatusBarOffsetPx(v.getContext()),
                        v.getPaddingRight(),
                        v.getPaddingBottom());
                v.getLayoutParams().height += getStatusBarOffsetPx(v.getContext());

                ViewGroup.LayoutParams oldParams = v.getLayoutParams();
                ViewGroup.LayoutParams newParams = new ViewGroup.LayoutParams(oldParams);
                if (oldParams instanceof LinearLayout.LayoutParams) {
                    newParams = new LinearLayout.LayoutParams(oldParams);
                } else if (oldParams instanceof RelativeLayout.LayoutParams) {
                    newParams = new RelativeLayout.LayoutParams(oldParams);
                } else if (oldParams instanceof FrameLayout.LayoutParams) {
                    newParams = new FrameLayout.LayoutParams(oldParams);
                } else if (oldParams instanceof ConstraintLayout.LayoutParams) {
                    newParams = new ConstraintLayout.LayoutParams(oldParams);
                }
    ...
    private void processM() {
        ...
        if (lightStatusBar) {
             ...
             * 改变字体颜色
             * see
             * {@link <a href="https://developer.android.com/reference/android/R.attr.html#windowLightStatusBar"></a>}
             */
