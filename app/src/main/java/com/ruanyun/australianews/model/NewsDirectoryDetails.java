...
public class NewsDirectoryDetails {
         ...
         * flag1 :
         * updateTime : null
         * oid : 4028818773b8357c0173b8376a6b0000
         * sort : 1
         * title : 欧盟对中111
         * pdfPagenum : 0
         * content :
         ...
         * duration : 0
         * createTime : null
         * fileUrl : 20200804144402933.pdf
         * sysUser : null
         * mark : false
         * watchCount : 0
         */
        private AfnNewsInfoEntity afnNewsInfo;
        private int uv;
        ...
        public AfnNewsInfoEntity getAfnNewsInfo() {
            return afnNewsInfo;
        }
        ...
        public class AfnNewsInfoEntity {
            /**
             * columnOid :
             * totalPagenum : 0
             * city :
