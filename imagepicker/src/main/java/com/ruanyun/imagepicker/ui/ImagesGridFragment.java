...
public class ImagesGridFragment extends Fragment implements
    ...
    private static final String[] PERMISSION = {Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA};
    Activity mContext;
...
//                }
    ...
    public void onImagesLoaded(List<ImageSet> imageSetList) {
        ...
        int index = androidImagePicker.getCurrentSelectedImageSetPosition();
        btnDir.setText(imageSetList.get(index).name);
        mAdapter = new ImageGridAdapter(mContext,
                imageSetList.get(index).imageItems);
        mGridView.setAdapter(mAdapter);
        mImageSetAdapter.setSelectIndex(index);
