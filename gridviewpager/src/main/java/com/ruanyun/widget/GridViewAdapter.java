...
public class GridViewAdapter extends BaseAdapter {
    ...
    public GridViewAdapter(Context context, List<IconModel> mData, int curIndex, int pageSize) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String iconRes = mData.get(pos).getIconRes();
//        viewHolder.iv.setImageResource(iconRes);
        Glide.with(context).load(iconRes).into(viewHolder.iv);
        return convertView;
    }
